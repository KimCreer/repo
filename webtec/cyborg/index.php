...
<body>
        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="../cyborg/index.php" class="active">Home</a></li>
                        ...
                        <li><a href="../dashboard.php">Profile <img src="../cyborg/ssets/images/profile-header.jpg" alt=""></a></li>
                    </ul>   
      ...
      <div class="col-lg-12">
        <div class="page-content">
              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="../cyborg/assets/images/popular-01.jpg" alt="">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="../cyborg/assets/images/popular-02.jpg" alt="">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="../cyborg/assets/images/popular-03.jpg" alt="">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="../cyborg/assets/images/popular-04.jpg" alt="">
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-sm-6">
                          <div class="item inner-item">
                            <img src="../cyborg/assets/images/popular-05.jpg" alt="">
                        ...
                        <div class="col-lg-6 col-sm-6">
                          <div class="item">
                            <img src="../cyborg/assets/images/popular-06.jpg" alt="">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="../cyborg/assets/images/popular-07.jpg" alt="">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="../cyborg/assets/images/popular-08.jpg" alt="">
          ...
          <div class="gaming-library">
            ...
            <div class="col-lg-12">
              <div class="main-button">
                <a href="dashboard.php">View Your Library</a>
              </div>
            </div>
          </div>
          <!-- ***** Gaming Library End ***** -->
  ...
  <script src="../cyborg/../cyborg/vendor/jquery/jquery.min.js"></script>
